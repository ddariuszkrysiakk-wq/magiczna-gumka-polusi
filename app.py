...
# 1. Suwaki do kontroli widoku, pędzla oraz przesunięcia kadru
...
# Obliczamy bazowe wymiary kadru widocznego na ekranie telefonu
base_w = int(raw_image.width * zoom_factor)
base_h = int(raw_image.height * zoom_factor)

# Ustawiamy stałą, wygodną szerokość okna podglądu dla telefonu (np. 350px)
...
# Dodatkowe suwaki przesuwania, jeśli obraz wykracza poza widok
        ...
        # 2. Wywołanie canvasa o stałym, dopasowanym rozmiarze
